...
/**
 * @typedef {function(number, number, number, Uint8Array=)}
 *
 * @description
 ...
 * segment.
 * The fourth argument is a chunk of data that was downloaded
 * (passed only for fetch request with StreamReader support)
 * @exportDoc
 */
shaka.extern.ProgressUpdated;
