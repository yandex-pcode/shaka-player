 ...
 * @export
 */
shaka.abr.SimpleAbrManager.prototype.chooseVariant = async function() {
 ...
 * @private
 */
shaka.abr.SimpleAbrManager.prototype.suggestStreams_ = async function() {
  ...
  let chosenVariant = await this.chooseVariant();
