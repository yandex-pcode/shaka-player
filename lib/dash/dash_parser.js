 ...
 *   baseUris: !shaka.dash.DashParser.BaseUrisHolder,
 *   availabilityTimeOffset: number
 * }}
 *
 * @description
 ...
 * @struct
 */
shaka.dash.DashParser.BaseUrisHolder = function(baseUris) {
     /**
      * The update period in seconds, or 0 for no updates.
      * @public {!Array.<string>}
      */
...
shaka.dash.DashParser.prototype.processManifest_ =
  ...
  let baseUrisRef;
  if (this.manifest_ && this.manifest_.baseUris) {
      baseUrisRef = this.manifest_.baseUris;
      baseUrisRef.baseUris_ = baseUris;
  } else {
      baseUrisRef = new shaka.dash.DashParser.BaseUrisHolder(baseUris);
  }
  ...
  let context = {
    ...
    baseUris: baseUrisRef,
    availabilityTimeOffset: availabilityTimeOffset,
  };

  let periodsAndDuration = this.parsePeriods_(context, [''], mpd);
...
shaka.dash.DashParser.prototype.parseRepresentation_ = function(
  ...
  this.minTotalAvailabilityTimeOffset_ = Math.min(this.minTotalAvailabilityTimeOffset_,
