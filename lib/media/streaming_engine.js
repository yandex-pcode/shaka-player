 ...
 *                        Promise<shaka.media.StreamingEngine.ChosenStreams>,
 ...
 *                Promise<shaka.media.StreamingEngine.ChosenStreams>} onChooseStreams
...
shaka.media.StreamingEngine.prototype.start = async function() {
  ...
  const initialStreams = await this.playerInterface_.onChooseStreams(
...
shaka.media.StreamingEngine.prototype.handlePeriodTransition_ = function(
  ...
  // onChooseStreams().
  this.setupPeriod_(needPeriodIndex).then(async function() {
    if (this.destroyed_) return;
    ...
    let chosenStreams = await this.playerInterface_.onChooseStreams(needPeriod);
