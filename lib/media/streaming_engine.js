...
shaka.media.StreamingEngine.prototype.fetchAndAppend_ = async function(
  ...
  try {
    if (isReadableStreamSupported && isMP4) {
      ...
      await this.fetch_(mediaState, stream, reference, streamDataCallback);
      await lastAppend;
    } else {
 ...
 * @private
 */
shaka.media.StreamingEngine.prototype.fetch_ = function(mediaState, stream, reference, streamDataCallback) {
