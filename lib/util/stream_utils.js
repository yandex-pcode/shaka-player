...
shaka.util.StreamUtils.chooseCodecsAndFilterManifest = function(
  ...
  let variantsByCodecs = new shaka.util.MultiMap();
  for (const variant of variants) {
    const group = StreamUtils.getGroupVariantCodecs_(variant);
 ...
 */
shaka.util.StreamUtils.filterVariantsByHeight_ = function(variantsByCodecs) {
